...
(function () {
  ...
  const html = `
    <div class="site-header">
      ...
      <nav class="menu-bar" role="navigation" aria-label="Menú principal">
        <div class="menu-bar-inner">
          ...
          <div class="menu-group">
            <span class="menu-group-label">🏘️ Servicios Turísticos</span>
            <div class="menu-group-items">
          ...
          <a href="${p}municipios-del-quindio.html"${active('municipios-del-quindio')}>🏘️ Municipios del Quindío</a>
          <a href="${p}quindio-comercial.html"${active('quindio-comercial')}>🛍️ Quindío Comercial</a>
          <a href="${p}anunciate.html"${active('anunciate')} style="font-weight:800;">📣 Anúnciate</a>
        </div>
      </nav>
    </div>
    <div class="nav-drawer" id="navDrawer">
      ...
      <div class="nav-drawer-section">
        <div class="nav-drawer-section-title">🏘️ Servicios Turísticos</div>
